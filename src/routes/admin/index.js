...
router.get('/product-form-options', adminController.productFormOptions);
router.get('/products/:id/cost-preview', adminController.productCostPreview);
router.post('/product-recipes/from-template', adminController.createRecipeFromTemplate);
